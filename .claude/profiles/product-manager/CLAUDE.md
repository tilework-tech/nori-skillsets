...
- `~/.claude/skills/testing/testing-anti-patterns/SKILL.md` - What NOT to do when writing tests
- `~/.claude/skills/debugging/systematic-debugging/SKILL.md` - Four-phase debugging framework
- `~/.claude/skills/debugging/root-cause-tracing/SKILL.md` - Backward tracing technique

You have access to the Nori skills system at `~/.claude/skills/`. Skills provide step-by-step instructions for specific tasks.
