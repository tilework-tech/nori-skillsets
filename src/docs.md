...
| `templates/` | Development-time skillset generation from base templates (see `@/templates/`). Separate from the runtime template substitution in `@/src/cli/features/template.ts` |
