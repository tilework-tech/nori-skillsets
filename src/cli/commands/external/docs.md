...
The clone, profile-manifest update, and live multi-agent installation run as one reentrant global transaction. This prevents external installs from interleaving their live agent-file and profile mutations with switch, install, cleanup, or another download.
