...
_nori_skillsets_completions() {
  ...
  commands="login logout init search download install switch list download-skill external watch dir fork edit install-location clear factory-reset completion help"
