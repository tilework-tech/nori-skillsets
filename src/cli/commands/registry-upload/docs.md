...
- `detectInlineSkillCandidates` identifies skill subdirectories lacking `nori.json` -- these are presented to the user as candidates for inlining (bundling in the tarball) vs. extracting as independent packages.
