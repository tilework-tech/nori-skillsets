...
**Announce at start:** "I'm using the Nori Receiving Code Review rule to handle this feedback."
...
**Reference finishing-a-development-branch rule (Steps 1-2):**

See `{{rules_dir}}/finishing-a-development-branch/RULE.md`
