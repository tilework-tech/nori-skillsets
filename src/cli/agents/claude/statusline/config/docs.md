...
Path: @/plugin/src/cli/features/statusline/config
...
**Build-time Substitution:** Version information is injected during build via perl substitution in @/plugin/package.json build script.
