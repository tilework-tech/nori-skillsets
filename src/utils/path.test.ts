...
describe("normalizeInstallDir", () => {
  describe("default behavior", () => {
    it("should return ~/.nori when no installDir provided", () => {
      const result = normalizeInstallDir({});
      expect(result).toBe(path.join(os.homedir(), ".nori"));
    });

    it("should return ~/.nori when installDir is null", () => {
      const result = normalizeInstallDir({ installDir: null });
      expect(result).toBe(path.join(os.homedir(), ".nori"));
    });

    it("should return ~/.nori when installDir is undefined", () => {
  ...
  describe("edge cases", () => {
    it("should handle empty string by using ~/.nori", () => {
