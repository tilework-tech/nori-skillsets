...
**`path.ts`** resolves installation directories through a priority chain: CLI flag > config value > home directory. Handles tilde expansion, relative-to-absolute conversion, and strips trailing `.claude` segments.
