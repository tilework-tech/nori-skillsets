...
6. Read and follow `/home/amol/code/nori/nori-skillsets/.worktrees/warm-bay-20260406-183354/.codex/skills/building-user-interface-elements/SKILL.md` to properly take the finished design and implement it.
</required>
