...
allowed-tools: Bash(node /home/amol/code/nori/nori-skillsets/.worktrees/new-agents/.cursor/skills/nori-sync-docs/script.js:*)
---
...
```bash
node /home/amol/code/nori/nori-skillsets/.worktrees/new-agents/.cursor/skills/nori-sync-docs/script.js
```
